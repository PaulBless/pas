...
<head>
    ...
    <!-- BEGIN BODY -->
<body class="padTop53" onload="Loading()">
 ...
 <!-- MAIN WRAPPER -->
    <div id="wrap" >
        ...
        <div id="content">
            ...
            <div class="inner" style="min-height: 700px;">
                <div class="row">
                    <div class="col-lg-12">
                       <!--page title/section-->
                        <h5><span class="fa fa-home"></span> E-Permit <i class="fa fa-chevron-right"></i> Main Menu <i class="fa fa-chevron-right"></i> Settings <i class="fa fa-chevron-right"></i> Checklist Items</h5>
                    </div>
                </div>
                  <hr />
        ...
        <div class="row">
            <div class="col-lg-12">
               <a href="checklist-add.php" class="btn btn-primary right" style="font-weight: bold"><i class="fa fa-plus"></i> Add New Checklist</a>
                <div class="box">
            <header><div class="icons"><i class="fa fa-tags"></i></div>
            <h5>CHECKLIST ITEMS </h5></header>
            ...
            <div class="panel-body">
                <div class="data-table-area mg-tb-15">
                  ...
                  <caption style="padding-bottom: 5px; color: #000"><span class="label label-warning" style="font-weight: bold; text-transform: uppercase; font-size: 13px">Checklist Items</span></caption>
                    ...
                    <!--table head-->
                        <thead class="text-warning" style="background: #000">
							...
							<th data-field="checkname">Checklist Name</th>
							<th data-field="comment">Description of Item</th>
							<th data-field="action">Action</th>
                        </tr>
                        </thead>
                        <tbody>
           <?php
            $sql=mysqli_query($connect_db,"SELECT * from check_list order by check_name ASC");
            $cnt=1;
        ...
        ?>
                ...
                <td><?php echo $last['check_name'] ?></td>
                <td><?php echo $last['comments'] ?></td>
                <td class="datatable-ct">
                <!--edit button-->
                <a href="check-edit.php?checklist_id=<?php echo $last['id'];?>" ><button class="btn btn-info btn-sm" id="checklistId"> <i class="fa fa-pencil-alt"></i> Edit</button></a>
                <!--delete link-->
                <a class="btn btn-danger btn-sm " href="./ajax/deletechecklist.php?checkId=<?php echo htmlentities($last['id']);?>" onclick="return confirm('Do you really want to delete this record?')"> <i class="fa fa-trash" style="margin-right: 3px;"></i> Delete</a>
<!--                <button type="submit" data-id="<?php echo htmlentities($last['id']); ?>" class="delete btn btn-default" onclick="deleteRecord()">Delete</button>-->
                </td>
                </tr>
    <?php
    $cnt=$cnt+1;        
...
<!--delete record function-->
	<script type="text/javascript">
		function deleteRecord(){
			var checkId = document.querySelector('checklistId').val(); 
			$(".spinning").show();
			alert ("item id : ") +checkId;
			jQuery.ajax({
			url: "delete.php",
			data:'checkId='+$("#checklistId").val(),
			type: "POST",
