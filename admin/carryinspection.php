...
-->
        ...
        <div id="content">
            ...
            <div class="inner" style="min-height: 700px;">
				...
				<a href="site-inspections.php" class="btn btn-warning btn-sm" onclick=""><i class="fa fa-arrow-left"></i> Go Back</a>
                 <!--HOME SECTION -->
        <div class="row">
            <div class="col-lg-12">
                                     
                <div class="box">
            <header><div class="icons"><i class="fa fa-anchor"></i></div>
...
<!--    <script src="../assets/datatable/js/data-table/bootstrap-table-export.js"></script>-->
   <!-- validation scripts-->
    ...
    <script type="text/javascript">
		$(document).ready(function() {
		//add event handler to inspect button in the datatable
