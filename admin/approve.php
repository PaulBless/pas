...
//sql statement
$approveDate = "";
$sql = "select dateEncode from approval where appID='$id'";
//get application approval records: if exists
$rest = $connect_db->query($sql);
if ($result->num_rows > 0) {
    while($rows = $rest->fetch_assoc()) {
    $approveDate = $rows["dateEncode"];  
    }
    }else{
    $approveDate = "";
}
...
{
    $note=($_POST['approvenote']);
    $remarks=ucwords($note);
    
    //sql statement
    $sql_check = "select dateEncode from approval where appID='$id'";
    //get application approval records: if exists
    $result = $connect_db->query($sql_check);
    if ($result->num_rows > 0) {
        while($row = $result->fetch_assoc())
            {
            $approveDate = $row["dateEncode"];       
            }
        ...
        . "<strong>&nbsp;&nbsp;Error Message!</strong> <br>This application has been approved for development permit grant on: <strong>$approveDate </strong>."
        . "</div>";   
        }else{
        //no record found
        //continue to approve application, change status
         $newApplication = new Applications();
        $sqlApprove = $newApplication->approveApplication($id);
        
        //insert approve remarks
        $add = mysqli_query($connect_db, "INSERT INTO `approval` (appID, reason, dateEncode) VALUES ('".$id."', '".$remarks."', CURRENT_TIMESTAMP)");
    ...
    echo "<div class='alert alert-success fadeIn col-lg-6 col-md-offset-3' style='top: 10px; transition: all 0.3s ease-in-out 0s'>"
        ...
        . "<strong>&nbsp;&nbsp;Congratulations! <br>Application successfully approved for development permit grant.</strong>."
        . "</div>";   
        }
    }
}
        ...
        <div id="content">
            ...
            <div class="inner" style="min-height: 700px;">
                <div class="row">
                    <div class="col-lg-12">
                       <!--page title/section-->
                        <h5><span class="fa fa-home"></span> E-Permit <i class="fa fa-chevron-right"></i> Main Menu <i class="fa fa-chevron-right"></i> Committee Decisions on Applications <i class="fa fa-chevron-right"></i> Approval Remarks</h5>
                    </div>     
                </div>
            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="box">
                        ...
                        <h5>APPROVE APPLICATION BASED ON COMMITTEE DECISION</h5></header>
            ...
            <div class="panel panel-default">
                 ...
                 <div class="panel-body">
                    <div class="panel panel-default">
                        ...
                        Application Approval Remarks</div>
                            <div class="panel-body">
                                <form role="form" id="form-newpermit" method="post" class="form-horizontal px-4 py-3" action="">

                                <div class="form-group">
                                    <label class="control-label col-lg-4">Enter Committee Decision / Remarks</label>
                                    <div class="col-lg-4">
                                        <input name="approvenote" id="approvenote" class="form-control" placeholder="" />
                                    </div>
                                    <div class="col-lg-4">
                                    <!--save button-->
...
//            valid: 'glyphicon glyphicon-ok',
        ...
        fields: {
            ...
            approvenote: {
                ...
                validators: {
                    notEmpty: {
                            message: 'Enter recommendation or approval remarks '
                        },
                    regexp: {
                        regexp: /^[a-zA-Z ]+$/,
