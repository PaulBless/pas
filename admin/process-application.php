...
<!--                <a href="new-application.php" data-toggle="" data-target="" class="btn btn-primary right" style="font-weight: bold"><i class="fa fa-plus" style="margin-right: 3px;"> </i>Add New Application</a>-->
                           
                <div class="box">
            <header><div class="icons"><i class="fa fa-briefcase"></i></div>
            <h5>PROCESS APPLICATIONS</h5></header>
...
-->
                    ...
                    <table id="table" data-toggle="table" data-pagination="true" data-search="true" data-show-columns="" data-show-pagination-switch="" data-show-refresh="" data-key-events="true" data-show-toggle="false" data-resizable="true" data-cookie="true" data-cookie-id-table="saveId" data-show-export="" data-click-to-select="true" data-toolbar="#toolbar" class="table table-striped table-bordered table-hover">
                    <!--table head-->
...
<!--                            <th data-field="mobile">Mobile No</th>-->
            ...
            <?php
                ...
                $currentYear = date("Y");
                $sql=mysqli_query($connect_db,"SELECT * from `applications` WHERE `status`='New' ORDER BY `applicationid` DESC");
                $cnt=1;
            ...
            ?>
                    ...
                    <!--process button link-->
                    <a href="permit-processing.php?applicationid=<?php echo $last['applicationid'];?>" ><button class="processBtn btn btn-primary btn-sm" id="appId" onclick="showSpin()" style="font-weight: bold"><i class="fa fa-arrow-right"></i> Process</button></a>
                    <!--defer button-->
                    <a href="holdapplication.php?applicationId=<?php echo ($last['applicationid']);?>"><button class="hold_btn btn btn-warning btn-sm" id="appId" onclick="showSpin()" name="btnHold" style="font-weight: bold"><i class="fa fa-key"></i> Hold</button></a>
...
//                $('#bauthors').val(row.bauthors);
//                $('#category').val(row.category);
//                $('#publisher').val(row.publisher);
//                $('#copyrightyear').val(row.copyrightyear);
//                $('#bsection').val(row.bsection);
//                $('#noOfCopies').val(row.noOfCopies);
//                $('#dateReceived').val(row.dateReceived);
//                $('#dateEncoded').val(row.dateEncoded);
//                console.log(row);
//                setTimeout(function(){
//                    $('.loading').hide();
//                },500);
