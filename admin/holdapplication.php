...
if(isset($_POST['btnSubmit'])){
    ...
    $reason = ($_POST['holdreason']); //get input data
    
    //update application status
    $update = mysqli_query($connect_db, "UPDATE `applications` SET `status`='Pending' WHERE `applicationid`=$app_id");  

    //insert holding reason
    $insert = mysqli_query($connect_db, "INSERT INTO `holding` (appID, reason) VALUES ('".$app_id."', '".$reason."')");
    ...
    echo "<div class='alert alert-success fadeIn col-lg-6 col-md-offset-3' style='top: 10px; transition: all 0.3s ease-in-out 0s'>"
        ...
        . "<strong>&nbsp;&nbsp;Success!!</strong> <br>This application has been put on hold/pending! You can process it later when required document(s) are presented.."
        . "</div>";    
}
        ...
        <div id="content">
            ...
            <div class="inner" style="min-height: 700px;">
                <div class="row">
                    <div class="col-lg-12">
                       <!--page title/section-->
                        <h5><span class="fa fa-home"></span> E-Permit <i class="fa fa-chevron-right"></i> Main Menu <i class="fa fa-chevron-right"></i> Applications <i class="fa fa-chevron-right"></i> Hold Application</h5>
                    </div>     
                </div>
            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="box">
                        ...
                        <h5>HOLD AN APPLICATION</h5></header>
                        ...
                        <div class="panel-heading">
                            ...
                            <div class="panel-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-4">
                                        <input name="holdreason" id="holdreason" class="form-control" placeholder="" />
                                    </div>
                                    <div class="col-lg-4">
                                    <!--save button-->
                                    <button class="btn btn-success" style="font-weight: bold" type="submit" name="btnSubmit"><i class="fa fa-check"></i> Confirm Hold</button>
                                    </div>
                                        </div>                       
                                </form>
                                </div>
