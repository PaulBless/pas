 ...
 <!-- MAIN WRAPPER -->
    <div id="wrap" >
        ...
        <div id="content">
            ...
            <div class="inner" style="min-height: 700px;">
                <div class="row">
                    <div class="col-lg-12">
                       <!--page title/section-->
                        <h5><span class="fa fa-home"></span> E-Permit <i class="fa fa-chevron-right"></i> Main Menu <i class="fa fa-chevron-right"></i> Transactions <i class="fa fa-chevron-right"></i> Grant Permit</h5>
                    </div>
                </div>
                  <hr />
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="box">
            <header><div class="icons"><i class="fa fa-book"></i></div>
            ...
            ?>
                    ...
                    <td class="text-success"><?php echo $last['status']; ?></td>
                    <td class="datatable-ct">
                    <!--process button link-->
                    <a href="assignpermit.php?assignId=<?php echo $last['applicationid'];?>" ><button class="processBtn btn btn-primary btn-sm" id="appId" style="font-weight: bold"> Grant <i class="fa fa-arrow-right"></i></button></a>
                    <!--defer button-->
