 ...
 <!-- MAIN WRAPPER -->
    <div id="wrap" >
        ...
        <div id="content">
            ...
            <div class="inner" style="min-height: 700px;">
                <div class="row">
                    <div class="col-lg-12">
                       <!--page title/section-->
                        <h5><span class="fa fa-home"></span> E-Permit <i class="fa fa-chevron-right"></i> Main Menu <i class="fa fa-chevron-right"></i> Statutory Planning Committee <i class="fa fa-chevron-right"></i> Decisions & Remarks</h5>
                    </div>
                </div>
                  <hr />
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="box">
            <header><div class="icons"><i class="fa fa-bookmark"></i></div>
            ...
            <?php
                ...
                $sql=mysqli_query($connect_db,"SELECT * from `applications` WHERE `status`='Submitted' ORDER BY `name` ASC");
                $cnt=1;
            ...
            ?>
                    ...
                    <!--defer button-->
                    <a href="defer.php?dataId=<?php echo ($last['applicationid']);?>"><button class="defer_btn btn btn-danger btn-sm" id="appId" name="btnDefer" onclick="showSpin()" style="font-weight: bold"><i class="fa fa-thumbs-down"></i> Defer</button></a>
