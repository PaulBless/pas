...
/*            color: white;*/
        ...
        .loading{
            ...
            height: 100vh;
            opacity:  0.5;
            background: url(../assets/images/ajax-loader-small.gif) no-repeat;
            z-index: 99999;
        }
    </style>
   </head>    <!-- END HEAD -->
 ...
 <!-- MAIN WRAPPER -->
    ...
    <div id="left" >
            ...
            <ul id="menu" class="collapse">
                ...
                <!--menu item-->
                <li class="panel active"><a href="tasks.php"><i class="fa fa-tasks"></i> Users Tasks </a></li>
                <!--menu item-->
        ...
        <div id="content">
            ...
            <div class="inner" style="min-height: 700px;">
                <div class="row">
                    <div class="col-lg-12">
                       <!--page title/section-->
                        <h5><span class="fa fa-home"></span> E-Permit <i class="fa fa-chevron-right"></i> Main Menu <i class="fa fa-chevron-right"></i> User Tasks </h5>
                    </div>
                </div>
                <hr />
