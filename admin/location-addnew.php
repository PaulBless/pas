...
if(isset($_POST['btnSubmit'])){
    ...
    if ($stmt = $connect_db->prepare('SELECT loc_name FROM locality WHERE loc_name = ?')) {
    ...
    echo "<div class='alert alert-danger bounceUp col-lg-6 col-md-offset-3' style='top: 10px; transition: transform .3s ease, -webkit-transform .3s ease, -moz-transform .3s ease, -o-transform .3s ease'>"
        ...
        . "<strong>&nbsp;&nbsp;Record Exists!</strong> </br>The location '$location' already added."
        . "</div>";
        
    }else{
    //save new record 
   if ($stmt = $connect_db->prepare('INSERT INTO locality (loc_name) VALUES (?)')){
	$stmt->bind_param('s', $location);
	$stmt->execute();
   ...
   <!-- MENU SECTION -->
       <div id="left" >
            ...
            <ul id="menu" class="collapse">
                ...
                <!--panel menu item-->
                <li><a href="committee-decisions.php"><i class="fa fa-bookmark"></i> Committtee Decisions </a></li>
        ...
        <div id="content">
            ...
            <div class="inner" style="min-height: 700px;">
                <div class="row">
                    <div class="col-lg-12">
                       <!--page title/section-->
                        <h5><span class="fa fa-home"></span> E-Permit <i class="fa fa-chevron-right"></i> Main Menu <i class="fa fa-chevron-right"></i> Locations <i class="fa fa-chevron-right"></i> Add New </h5>
                    </div>
                </div>
                  <hr />
                   ...
                   <a href="locations.php" class="btn btn-warning text-center"> <i class="fa fa-arrow-left" style="margin-right: 3px;"></i> Go Back</a>
                    <div class="box">
                        ...
                        <div class="form-group">
                            <label class="control-label col-lg-4">Location or Community Name</label>
                            <div class="col-lg-4">
                                <input name="location" id="location" class="form-control" placeholder="" />
                                <p class="help-block">Provide name of location (eg. Adeiso)</p>
                            </div>
                            <div class="col-lg-4">
                            <!--save button-->
                            <button class="btn btn-success" style="font-weight: bold" type="submit" name="btnSubmit"><i class="fa fa-save"></i> Save</button>
                            </div>
                        </div>
