...
if (!isset($_SESSION['loggedin'])) {
    ...
    $landid = "";
    if(isset($_GET['landuse_id']))
    $landid = ($_GET['landuse_id']);

    //global
    $landid = ($_GET['landuse_id']);
    $stmt = mysqli_query($connect_db, "SELECT * FROM landuse WHERE id='$landid'");
    #bind result set
    ...
    if(isset($_POST['btnUpdate'])){
        ...
        //get form data
        $newlocation = ucwords($_POST['landuse']);
        $newcomment = ucfirst($_POST['comment']);

        //update the record 
       if ($stmt = $connect_db->prepare('UPDATE landuse SET `land_use`= ?, `comments`= ? WHERE id= ?')){
        $stmt->bind_param('ssi', $newlocation, $newcomment, $landid);
        $stmt->execute();
        ...
        <div id="content">
            ...
            <div class="inner" style="min-height: 700px;">
                <div class="row">
                    <div class="col-lg-12">
                       <!--page title/section-->
                        <h5><span class="fa fa-home"></span> E-Permit <i class="fa fa-chevron-right"></i> Main Menu <i class="fa fa-chevron-right"></i> Landuse <i class="fa fa-chevron-right"></i> Update </h5>
                    </div>
                </div>
                  <hr />
                   ...
                   <a href="landuse.php" class="btn btn-warning text-center"> <i class="fa fa-arrow-left" style="margin-right: 3px;"></i> Go Back</a>
                    <div class="box">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-4">
                                <input name="landuse" id="landuse" class="form-control" value="<?php echo $record['land_use']; ?>" />
                            </div>
                        </div>
                        <!--description-->
                        <div class="form-group">
                        ...
                        <!--button for action-->
                        <div class="form-actions no-margin-bottom" style="text-align:center; padding-top: 0px; padding-left: 160px;">
                            <button class="btn btn-success" type="submit" name="btnUpdate" style="font-weight: bold"><i class="fa fa-paper-plane"></i> Update</button>
                            <button class="btn btn-danger" style="font-weight: bold" type="reset" name="btnclose"><i class="fa fa-times"></i> Cancel</button>
                        </div>
