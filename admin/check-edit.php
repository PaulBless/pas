...
if(isset($_GET['checklist_id']))
    ...
    //global
    $checklustid = ($_GET['checklist_id']);
    $stmt = mysqli_query($connect_db, "SELECT * FROM `check_list` WHERE id='$checklistid'");
    #bind result set
...
if(isset($_POST['btnUpdate'])){
        ...
        //get form data
        $newcheckname = ucwords($_POST['checkname']);
        $newcomment = ucfirst($_POST['comment']);

        //update the record 
       if ($stmt = $connect_db->prepare('UPDATE `check_list` SET `check_name`= ?, `comments`= ? WHERE id= ?')){
        $stmt->bind_param('ssi', $newcheckname, $newcomment, $checklistid);
        $stmt->execute();
    ...
    echo "<div class='alert alert-info fade in col-lg-6 col-md-offset-3' style='top: 10px; transition: all 0.3s ease-in-out'>"
	...
	echo 'Ooops... Could not prepare sql statement!';
        }  
    }
    ...
    <div id="wrap" >
       ...
       <div id="left" >
            ...
            <ul id="menu" class="collapse">
                ...
                <!--panel menu item-->
                <li><a href="committee-decisions.php"><i class="fa fa-eye"></i> Site Inspections </a></li>
        ...
        <div id="content">
            ...
            <div class="inner" style="min-height: 700px;">
                <div class="row">
                    <div class="col-lg-12">
                       <!--page title/section-->
                        <h5><span class="fa fa-home"></span> E-Permit <i class="fa fa-chevron-right"></i> Main Menu <i class="fa fa-chevron-right"></i> Checklist <i class="fa fa-chevron-right"></i> Update </h5>
                    </div>
                </div>
                  <hr />
            ...
            <div class="row">
                <div class="col-lg-12">
                   <a href="check-lists.php" class="btn btn-warning text-center"> <i class="fa fa-arrow-left" style="margin-right: 3px;"></i> Go Back</a>
                    <div class="box">
                        <header>
                        <div class="icons"><i class="fa fa-check"></i>
                        </div>
                        <h5>Edit Checklist Item</h5></header>
                        ...
                        <div class="form-group">
                            <label class="control-label col-lg-4">Checklist Item  </label>
                            <div class="col-lg-4">
                                <input name="checkname" id="checkname" class="form-control" value="<?php echo $record['check_name']; ?>" />
                            </div>
                        </div>
                        <!--description-->
                        <div class="form-group">
                            ...
                            <div class="col-lg-4">
                                <input name="comment" id="comment" class="form-control" value="<?php echo $record['comments']; ?>" />
                                <p class="help-block">Provide checklist item description </p>
                            </div>
                        </div> 
                    
                        <!--button for action-->
                        <div class="form-actions no-margin-bottom" style="text-align:center; padding-top: 20px; padding-left: 250px;">
                            <button class="btn btn-success " type="submit" name="btnUpdate" style="font-weight: bold"><i class="fa fa-paper-plane"></i> Update</button>
                        </div>
...
//            valid: 'glyphicon glyphicon-ok',
    ...
    //checkname keypress validation
    jQuery("#checkname").keypress(function(ev){
//        var x = $(this).val();
