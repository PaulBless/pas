	 ...
	 <!-- MAIN WRAPPER -->
       ...
       <div id="left" >
            ...
            <ul id="menu" class="collapse">
                ...
                <!--menu item-->
                <li class="panel active"><a href="application-lists.php"><i class="fa fa-th"></i> Application Lists </a></li>
                <!--menu item-->
        ...
        <div id="content">         
            <div class="inner" style="min-height: 700px;">
                <div class="row">
                    <div class="col-lg-12">
                       <!--page title/section-->
                        <h5><span class="fa fa-home"></span> E-Permit <i class="fa fa-chevron-right"></i> User Dashboard <i class="fa fa-chevron-right"></i> Application Lists</h5>
                    </div>
                </div>
                  <hr />
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="box">
                        ...
                        <h5>LIST OF APPLICATIONS</h5></header>
                		...
                		<div class="data-table-area mg-tb-15">
							...
							<th data-field="permitno" width="">Site Location</th>
							<th data-field="dateApply"  width="">Date Applied</th>
							<th data-field="date"  width="">Status</th>
							</tr>
						</thead>
							<tbody>
			<?php
				 $cnt=1;    //COUNTER
				$sql_get = "SELECT * FROM `applications` ORDER BY `datecreated` ASC";
...
<!--						<td><?php //echo ($row['applicationid']); ?></td>-->
						<td class="text-danger"><?php echo ($row['application_no']); ?></td>
						<td><?php echo $row['name']; ?></td>
						<td><?php echo $row['phoneno']; ?></td>
						<td><?php echo $row['project_type']; ?></td>
						<td><?php $qry=mysqli_query($connect_db, "SELECT `loc_name` FROM `locality` WHERE `id`='".$row['location']."'"); $data=mysqli_fetch_assoc($qry); echo $data['loc_name'];?></td>
